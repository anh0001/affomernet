...
Fine-tune from previous trained model
```bash
export CUDA_VISIBLE_DEVICES=0
...
python tools/export_onnx.py -c configs/rtdetr/rtdetr_r50vd_6x_iit.yml -r output/rtdetr_r50vd_6x_iit/checkpoint0071.pth --check -f output/rtdetr_r50vd_6x_iit_1.onnx
```
...
python tools/export_onnx.py --inference --dataset iit --file-name output/rtdetr_r50vd_6x_iit_1.onnx --image dataset/iit/data/VOCdevkit2012/VOC2012/JPEGImages/0.jpg
```
